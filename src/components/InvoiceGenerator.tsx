...
import { Receipt, FileText, Euro, Plus, Trash2, Save, X, AlertCircle, CheckCircle } from 'lucide-react';
...
const InvoiceGenerator: React.FC<InvoiceGeneratorProps> = ({ 
  ...
  // Items de la factura
  const [items, setItems] = useState<Omit<InvoiceItem, 'id' | 'subtotal' | 'taxAmount' | 'total'>[]>([
    {
  ...
  const validateForm = (): boolean => {
    ...
    items.forEach((item, index) => {
      ...
      if (item.unitPrice <= 0) {
        errors[`item${index}UnitPrice`] = 'El precio unitario debe ser mayor a 0';
      }
      if (item.taxRate < 0 || item.taxRate > 100) {
        errors[`item${index}TaxRate`] = 'El tipo de IVA debe estar entre 0 y 100';
      }
    });
  ...
  const createInvoice = async () => {
    ...
    try {
      ...
      setError(`❌ Error al crear la factura: ${error instanceof Error ? error.message : 'Error desconocido'}`);
    } finally {
      setLoading(false);
    }
  };

  const calculateItemTotals = (item: Omit<InvoiceItem, 'id' | 'subtotal' | 'taxAmount' | 'total'>) => {
        ...
        <div className="bg-gradient-to-r from-pastel-blue to-pastel-blue-light px-6 py-4 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-primary-700">Generar Factura</h2>
                <p className="text-primary-600 text-sm">
                  Paciente: {medicalRecord.patientName} {medicalRecord.patientSurname}
                </p>
              </div>
            </div>
            <button
        ...
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 ${
                    validationErrors.companyName ? 'border-red-300' : 'border-pastel-gray-light'
                  }`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 ${
                    validationErrors.taxId ? 'border-red-300' : 'border-pastel-gray-light'
                  }`}
                  placeholder="NIF/CIF"
                />
                {validationErrors.taxId && (
                  <p className="text-red-600 text-sm mt-1">{validationErrors.taxId}</p>
                )}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 ${
                    validationErrors.address ? 'border-red-300' : 'border-pastel-gray-light'
                  }`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 ${
                    validationErrors.city ? 'border-red-300' : 'border-pastel-gray-light'
                  }`}
                  placeholder="Ciudad"
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 ${
                    validationErrors.postalCode ? 'border-red-300' : 'border-pastel-gray-light'
                  }`}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleCompanyInfoChange('province', e.target.value)}
                  className={`w-full px-3 py-2 border rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 ${
                    validationErrors.province ? 'border-red-300' : 'border-pastel-gray-light'
                  }`}
                  placeholder="Provincia"
                />
                {validationErrors.province && (
                  <p className="text-red-600 text-sm mt-1">{validationErrors.province}</p>
                )}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 ${
                    validationErrors.phone ? 'border-red-300' : 'border-pastel-gray-light'
                  }`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 ${
                    validationErrors.email ? 'border-red-300' : 'border-pastel-gray-light'
                  }`}
                  placeholder="Email"
                />
          ...
          <div className="mb-8">
            ...
            {items.map((item, index) => (
              <div key={index} className="border border-pastel-gray-light rounded-xl p-4 mb-4">
                <div className="grid grid-cols-1 md:grid-cols-6 gap-4 items-end">
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-2 border rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 ${
                        validationErrors[`item${index}Description`] ? 'border-red-300' : 'border-pastel-gray-light'
                      }`}
                      placeholder="Descripción del servicio"
                    />
                    {validationErrors[`item${index}Description`] && (
                      <p className="text-red-600 text-sm mt-1">{validationErrors[`item${index}Description`]}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-2 border rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 ${
                        validationErrors[`item${index}Quantity`] ? 'border-red-300' : 'border-pastel-gray-light'
                      }`}
                    />
                    {validationErrors[`item${index}Quantity`] && (
                      <p className="text-red-600 text-sm mt-1">{validationErrors[`item${index}Quantity`]}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-2 border rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 ${
                        validationErrors[`item${index}UnitPrice`] ? 'border-red-300' : 'border-pastel-gray-light'
                      }`}
                    />
                    {validationErrors[`item${index}UnitPrice`] && (
                      <p className="text-red-600 text-sm mt-1">{validationErrors[`item${index}UnitPrice`]}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-2 border rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 ${
                        validationErrors[`item${index}TaxRate`] ? 'border-red-300' : 'border-pastel-gray-light'
                      }`}
                    />
                    {validationErrors[`item${index}TaxRate`] && (
                      <p className="text-red-600 text-sm mt-1">{validationErrors[`item${index}TaxRate`]}</p>
                    )}
                  </div>

                  <div className="flex items-center space-x-2">
                    <div className="text-sm text-pastel-gray-dark">
                      <div>Subtotal: {calculateItemTotals(item).subtotal.toFixed(2)}€</div>
                      <div>Total: {calculateItemTotals(item).total.toFixed(2)}€</div>
                    </div>
                    {items.length > 1 && (
                      <button
          ...
          <div className="bg-pastel-gray-light rounded-xl p-6 mb-8">
            <h3 className="text-lg font-semibold text-primary-700 mb-4">Resumen de la Factura</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="text-center">
                <p className="text-sm text-pastel-gray-dark">Subtotal</p>
                <p className="text-2xl font-bold text-primary-700">{invoiceTotals.subtotal.toFixed(2)}€</p>
              </div>
              <div className="text-center">
                <p className="text-sm text-pastel-gray-dark">Total</p>
                <p className="text-3xl font-bold text-primary-700">{invoiceTotals.total.toFixed(2)}€</p>
              </div>
            </div>
            <div className="mt-4 text-center">
              <p className="text-sm text-pastel-gray-dark">
                <strong>Asistencia sanitaria exenta de IVA</strong> según Art. 20.1.9º Ley 37/1992
              </p>
            </div>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-8">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="font-medium text-blue-900 mb-2">Cumplimiento Legal</h4>
                <p className="text-sm text-blue-700 mb-2">
                  Esta factura se generará cumpliendo rigurosamente con el <strong>Real Decreto 1007/2023</strong> 
                  (Reglamento Verifactu) que establece el marco regulador de los Sistemas Informáticos de Facturación (SIF).
                </p>
                <ul className="text-sm text-blue-700 space-y-1">
                  ...
                  <li>• <strong>Asistencia sanitaria exenta de IVA</strong> según Art. 20.1.9º Ley 37/1992</li>
                </ul>
              </div>
            </div>
          </div>
